    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex ml-6 items-center">
            ...
            <div className="relative">
              <select value={size} onChange={(e)=>{refreshVariant(e.target.value, color)}} className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-pink-500 text-base pl-3 pr-10">
                ...
                {Object.keys(variants[color]).includes('XXL') && <option value={"XXL"}>XX</option>}
        ...
        <div className="flex">
          ...
          <button className="flex ml-8 text-white bg-pink-500 border-0 py-2 px-4 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
          <button className="flex ml-2 text-white bg-pink-500 border-0 py-2 px-4 focus:outline-none hover:bg-pink-600 rounded" onClick={()=>{addToCart(slug,1,product.title,400,product.size,product.color)}}>Add to Cart</button>
        ...
        <button onClick={handlecheck} className="flex ml-2 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Check</button>
         ...
         {!accessability && (accessability !=null) && <div>sorry! not include</div>}
