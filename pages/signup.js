...
const Signup = () => {
  ...
  <div className="px-6 h-full text-gray-800">
    <div
      className="flex xl:justify-center lg:justify-between justify-center my-16 flex-wrap h-full g-6"
    >
      ...
      <img className='mx-auto h-12 w-auto mb-8' src='logo.png'></img>
        ...
        <form>
          <div className="flex flex-row items-center justify-center lg:justify-start">
            <p className="text-lg mb-0 mr-4 font-bold">Sign Up with</p>
            <button
              type="button"
          ...
          <div className="text-center lg:text-left">
            ...
            Have an account?
              <a className="text-pink-600 hover:text-pink-700 focus:text-pink-700 transition duration-200 ease-in-out"
                > <Link href={"/login"}>Log In</Link></a>
            </p>
          </div>
        </form>
      </div>
